...
@route("/static_file", ProcessType.main)
...
@route("/cached_file", ProcessType.main)
...
@route("/file/<filename>", ProcessType.main)
...
@route("/error-local", ProcessType.main)
def crash_local(env):
...
@route("/async", ProcessType.main_async)
...
@route("/proc", ProcessType.process_pool)
def proc_pool(env):
...
@route("/stream", ProcessType.stream)
def stream(env):
...
@route("/shutdown", ProcessType.main)
def end_server(env):
